...
import static project.users.app.Urls.reg_url;
...
import project.users.app.databinding.ActivityRegisterBinding;

public class RegisterActivity extends AppCompatActivity {
    private ActivityRegisterBinding binding;
    String url = "http://192.168.0.107/CMS/register.php";
    @Override
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        if (object.get("code").equals("201")) {
                                            ...
                                            Intent intent = new Intent(RegisterActivity.this, RegistrationCompletdActivity.class);
