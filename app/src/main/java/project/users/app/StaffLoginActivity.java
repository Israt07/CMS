...
import static project.users.app.Urls.login_url;
import static project.users.app.Urls.staff_login_url;
...
import project.users.app.databinding.ActivityStaffLoginBinding;

public class StaffLoginActivity extends AppCompatActivity {
    private ActivityStaffLoginBinding binding;
    String url = "http://192.168.0.107/CMS/stafflogin.php";
    @Override
